...
Programda birden fazla kalıtım türünün kombinasyonuna denir. Örneğin, C ve B sınıfı, A sınıfını genişletir ve başka bir D sınıfı, B ve C sınıfını genişletir, bu bir hibrit kalıtım örneğidir, çünkü bu, çoklu ve hiyerarşik kalıtımın bir birleşimidir.
